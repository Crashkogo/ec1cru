            ...
            <div className="space-y-6">
              {activeAboutTab === 'history' && (
                <>
                  ...
                  <div className="space-y-4 text-modern-gray-600">
                    <p>
                      «Инженер-центр» — это более 30 лет автоматизации бизнеса. За плечами — более
                      50 успешных проектов внедрения и 600+ довольных клиентов. От маленьких
                      компаний до крупных корпораций.
                    </p>
                    <p className="font-semibold text-modern-gray-800">Что мы делаем?</p>
                    <p>Внедряем и сопровождаем 1С.</p>
                    <p>
                      Предоставляем IT-аутсорсинг — полностью берём на себя вашу IT-инфраструктуру.
                      Серверы, сети, компьютеры, защита, обновления, поддержка пользователей. Вы не
                      отвлекаетесь на технику — мы решаем все вопросы за вас.
                    </p>
                    <p>
                      Наша команда — это сертифицированные специалисты. Они постоянно повышают
                      квалификацию, следят за новейшими тенденциями и применяют лучшее на практике.
                    </p>
                    <p className="font-semibold text-modern-primary-700">
                      Наша цель: сделать IT незаметным. Чтобы вы занимались бизнесом, а всё
              ...
              {activeAboutTab === 'team' && (
                <>
                  ...
                  <div className="space-y-4 text-modern-gray-600">
                    <p className="font-semibold text-modern-gray-800">
                      Команда, на которую можно положиться
                    </p>
                    <p>За нашей работой стоят люди. Живые, увлечённые, надёжные.</p>
                    <p>
                      Разработчики, которые пишут код так, чтобы его не стыдно было показать
                      коллегам. Консультанты, которые говорят с бизнесом на одном языке. Системные
                      администраторы, которые держат всю IT-инфраструктуру в порядке — тихо, без
                      паники, но с полным контролем. Специалисты техподдержки, которые не бросают
                      трубку, пока проблема не решена. И преподаватели учебного центра, которые учат
                      других так, как хотели бы, чтобы учили их.
                    </p>
                    <p>
                      У каждого из нас — официальные сертификаты 1С. Мы регулярно учимся, сдаём
                      экзамены, перенимаем лучшее у коллег. Потому что спокойствие клиента стоит
                      того.
                    </p>
                    <p className="font-semibold text-modern-primary-700">
              ...
              {activeAboutTab === 'careers' && (
                <>
                  ...
                  <div className="space-y-4 text-modern-gray-600">
                    <p>
                      Мы всегда рады видеть в команде талантливых и амбициозных специалистов. Тех,
                      кто хочет расти в IT и не боится сложных задач.
                    </p>
                    <p className="font-semibold text-modern-gray-800">Что мы предлагаем?</p>
                    <p>
                      Стабильную работу. Дружный коллектив, в котором не страшно спросить и не
                      стыдно ошибиться. Возможности для профессионального роста — реальные, а не на
                      словах. Обучение за счёт компании, потому что мы верим: инвестиции в людей —
                      лучшие инвестиции.
                    </p>
                    <p>
                      И ещё — менторскую поддержку. Мы не бросаем новичков в открытое море. Рядом
                      есть тот, кто направит, подскажет, поможет раскрыть потенциал.
                    </p>
                  </div>
                  <div className="flex items-center space-x-4 pt-4">
