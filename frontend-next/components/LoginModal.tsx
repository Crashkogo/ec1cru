...
const LoginModal: React.FC<LoginModalProps> = ({ showLogin, setShowLogin }) => {
  ...
  const handleEmployeeLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Attempting login with:', { username: employeeData.name });
      ...
      const errorMessage = err.response?.data?.message || err.message || 'Неверное имя пользователя или пароль';
