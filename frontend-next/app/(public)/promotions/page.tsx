...
export default function PromotionsPage() {
  ...
  const fetchPromotions = async (reset = false) => {
    ...
    try {
      ...
      if (statusFilter !== null) params.append('status', String(statusFilter));
      if (dateFrom) params.append('dateFrom', dateFrom);
      if (dateTo) params.append('dateTo', dateTo);

      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/posts/promotions?${params.toString()}`
      );
      ...
      const newItems: PromotionItem[] = await response.json();
