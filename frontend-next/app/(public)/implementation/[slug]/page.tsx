        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {[
              ...
              {
                question: 'Придётся останавливать производство?',
                answer:
                  'Нет. Внедрение идёт параллельно с текущей работой предприятия. На финальном этапе «перехода» требуется 1–2 рабочих дня для переноса остатков и тестирования.',
              },
              {
