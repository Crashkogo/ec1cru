...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="bg-modern-gray-900 text-white" style={{ border: 'none', outline: 'none', boxShadow: 'none' }}>
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8" style={{ border: 'none', outline: 'none', boxShadow: 'none' }}>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6" style={{ border: 'none', outline: 'none' }}>

                    {/* Компания */}
                    <div>
                        <h3 className="text-lg font-semibold mb-3">Компания</h3>
                        <ul className="space-y-1 text-modern-gray-300">
                            <li><Link to="/about" className="hover:text-white transition-colors duration-200">О компании</Link></li>
                            <li><Link to="/otzyvy" className="hover:text-white transition-colors duration-200">Отзывы</Link></li>
                            <li><Link to="/team" className="hover:text-white transition-colors duration-200">Супер команда</Link></li>
                            <li><a href="https://career-ec.ru/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors duration-200">Работа у нас</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-1 text-modern-gray-300">
                            <li><Link to="/1c-programs" className="hover:text-white transition-colors duration-200">Программы 1С</Link></li>
                            <li><Link to="/1c-services" className="hover:text-white transition-colors duration-200">Сервисы 1С</Link></li>
                            <li><Link to="/ready-solutions" className="hover:text-white transition-colors duration-200">Наши разработки</Link></li>
                            <li><Link to="/zabbix" className="hover:text-white transition-colors duration-200">Zabbix</Link></li>
                            <li><Link to="/equipment" className="hover:text-white transition-colors duration-200">Оборудование</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-1 text-modern-gray-300">
                            ...
                            <li><Link to="/tech-maintenance" className="hover:text-white transition-colors duration-200">IT-аутсорсинг</Link></li>
                            <li><Link to="/1c-courses" className="hover:text-white transition-colors duration-200">Курсы 1С</Link></li>
                            <li><Link to="/certification" className="hover:text-white transition-colors duration-200">Сертификация</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-2 text-modern-gray-300">
                            ...
                            <div className="flex items-center">
                                <PhoneIcon className="h-4 w-4 mr-2 flex-shrink-0" />
                                <a href="tel:+78443300200" className="hover:text-white transition-colors duration-200">
                                    8 (8443) 300-200
                                </a>
                            </div>
                            ...
                            <div className="flex items-center">
                                <EnvelopeIcon className="h-4 w-4 mr-2 flex-shrink-0" />
                                <a href="mailto:it@enginf.ru" className="hover:text-white transition-colors duration-200">
                                it@enginf.ru
                                </a>
                            </div>
                            ...
                            <div className="flex items-start mt-4">
                                ...
                                <p className="text-sm leading-relaxed">
                                    г. Волжский, ул. Карбышева 76,<br />
                                    БЦ Акрас-Центр, 825, 827 офис,<br />
                                    8 этаж
                                </p>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                <div className="text-sm font-medium text-modern-gray-300 hover:text-white">1С-Гэндальф</div>
                            ...
                            <a
                                ...
                                className="block bg-modern-gray-800 hover:bg-modern-gray-700 rounded-lg p-3 text-center transition-colors duration-200"
                            >
                                <div className="text-sm font-medium text-modern-gray-300 hover:text-white">КАМИН</div>
                                <div className="text-xs text-modern-gray-400 mt-1">Партнёр</div>
                            </a>
                        </div>
                    </div>
