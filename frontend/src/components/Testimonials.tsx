...
const Testimonials: React.FC = () => {
  ...
  const staticTestimonials: Testimonial[] = useMemo(() => [
    {
      ...
      content: 'Сотрудничаем с компанией Инженер-центр уже более 5 лет. За это время наша компания значительно автоматизировала бизнес-процессы благодаря внедрению решений на базе 1С. Особенно хочется отметить профессионализм специалистов технической поддержки.',
    },
    {
      id: 2,
      companyName: 'ЗАО "Волгоградский металлургический завод"',
      slug: 'zao-volgogradskii-metallurgicheskii-zavod',
      content: 'Выражаем благодарность команде Инженер-центр за качественное внедрение системы управления производством на нашем предприятии. Проект был реализован точно в срок, несмотря на сложность производственных процессов.',
    },
    {
      id: 3,
      companyName: 'ИП Морозов А.В.',
      slug: 'ip-morozov-a-v',
      content: 'Как индивидуальный предприниматель, я долго искал надежного партнера для ведения бухгалтерии. Обратился в Инженер-центр по рекомендации коллег - и не пожалел! Установили 1С:Бухгалтерию, провели обучение.',
    },
    {
      id: 4,
      companyName: 'ООО "Строительная компания Альфа"',
      slug: 'ooo-stroitelnaia-kompaniia-alfa',
      content: 'Сотрудничаем с Инженер-центр с момента основания нашей строительной компании. За 7 лет совместной работы внедрили несколько конфигураций 1С, настроили интеграции, автоматизировали документооборот.',
    },
    {
      id: 5,
      companyName: 'АО "Южные молочные продукты"',
      slug: 'ao-iuzhnye-molochnye-produkty',
      content: 'Наше молочное производство требовало современной системы учета с учетом специфики пищевой промышленности. Инженер-центр предложили и внедрили комплексное решение на базе 1С:Управление производственным предприятием.',
    },
    {
      id: 6,
      companyName: 'ООО "ТехноПром"',
      slug: 'ooo-tekhnoprom',
      content: 'Благодарим за оперативную техническую поддержку и качественное обслуживание наших систем 1С. Все вопросы решаются быстро и профессионально. IT-аутсорсинг от Инженер-центр позволяет нам сосредоточиться на основном бизнесе.',
    },
    {
      id: 7,
      companyName: 'ЗАО "Продторг-Юг"',
      slug: 'zao-prodtorg-iug',
      content: 'Отличная команда специалистов! Помогли настроить интеграцию между 1С и нашим интернет-магазином. Теперь все заказы автоматически попадают в учетную систему, что значительно экономит время и исключает ошибки.',
    },
    {
      id: 8,
      companyName: 'ООО "МедСнаб"',
      slug: 'ooo-medsnab',
      content: 'Внедрили 1С:Управление торговлей с учетом специфики медицинского оборудования. Особенно ценим индивидуальный подход и готовность специалистов Инженер-центр разобраться во всех нюансах нашего бизнеса.',
    },
  ], []);
    ...
    const fetchTestimonials = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/api/posts/testimonials`
        );
        ...
        console.warn('Не удалось загрузить отзывы с сервера, используем статичные данные:', error);
        setTestimonials(staticTestimonials);
      } finally {
        setLoading(false);
      }
  ...
  if (testimonials.length === 0) {
    return (
      <>
        <Helmet>
          <title>Отзывы клиентов - ООО «Инженер-центр»</title>
        </Helmet>
        <div className="min-h-screen bg-modern-gray-50 flex items-center justify-center">
          <div className="text-center">
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Отзывы наших клиентов о качестве услуг по внедрению и поддержке 1С, IT-аутсорсингу и автоматизации бизнеса."
        />
      </Helmet>
      ...
      <div className="min-h-screen bg-modern-gray-50">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-modern-gray-900 mb-4">
              Отзывы наших клиентов
            </h1>
            <p className="text-lg text-modern-gray-600 max-w-3xl mx-auto">
              Мы гордимся доверием наших клиентов и результатами совместной работы.
              Более 30 лет помогаем компаниям автоматизировать бизнес-процессы на базе 1С.
            </p>
          </div>
